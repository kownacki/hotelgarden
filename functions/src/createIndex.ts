...
<script>
  ...
  body {
    ...
    --primary-color-filter: invert(31%) sepia(28%) saturate(718%) hue-rotate(121deg) brightness(93%) contrast(88%);
  
    
    --secondary-color: #E2A96A;
    --secondary-color-rgb: 226, 169, 106;
    --secondary-color-filter: invert(94%) sepia(92%) saturate(1806%) hue-rotate(307deg) brightness(94%) contrast(87%);
  
    
    --secondary-dark-color: #da903f;
    --secondary-dark-color-rgb: 218, 144, 63;
    --secondary-dark-color-filter: invert(69%) sepia(71%) saturate(739%) hue-rotate(331deg) brightness(92%) contrast(85%);
  
    
    --text-color: #424242;
    --text-color-rgb: 66, 66, 66;
    --text-color-filter: invert(19%) sepia(12%) saturate(17%) hue-rotate(327deg) brightness(90%) contrast(75%);
  
    
    --surface-color: #D5D8D9;
    --surface-color-rgb: 213, 216, 217;
    --surface-color-filter: invert(91%) sepia(8%) saturate(59%) hue-rotate(149deg) brightness(98%) contrast(84%);
  
    
    --surface-light-color: #f5f5f5;
    --surface-light-color-rgb: 245, 245, 245;
    --surface-light-color-filter: invert(99%) sepia(95%) saturate(115%) hue-rotate(199deg) brightness(115%) contrast(92%);
  
    
    --surface-dark-color: #757575;
    --surface-dark-color-rgb: 117, 117, 117;
    --surface-dark-color-filter: invert(54%) sepia(2%) saturate(6%) hue-rotate(320deg) brightness(83%) contrast(93%);
  
    
    --on-surface-color: #424242;
    --on-surface-color-rgb: 66, 66, 66;
    --on-surface-color-filter: invert(19%) sepia(12%) saturate(17%) hue-rotate(327deg) brightness(90%) contrast(75%);
  
    
    --placeholder-color: #9e9e9e;
    --placeholder-color-rgb: 158, 158, 158;
    --placeholder-color-filter: invert(74%) sepia(0%) saturate(5657%) hue-rotate(54deg) brightness(87%) contrast(73%);
  
    
    --error-color: #c62828;
    --error-color-rgb: 198, 40, 40;
    --error-color-filter: invert(23%) sepia(61%) saturate(3324%) hue-rotate(347deg) brightness(83%) contrast(88%);
  
    
    --error-background-color: #ffcdd2;
    --error-background-color-rgb: 255, 205, 210;
    --error-background-color-filter: invert(78%) sepia(47%) saturate(224%) hue-rotate(307deg) brightness(102%) contrast(101%);
  
    
    --correct-color: #2e7d32;
    --correct-color-rgb: 46, 125, 50;
    --correct-color-filter: invert(42%) sepia(13%) saturate(2062%) hue-rotate(73deg) brightness(92%) contrast(94%);
