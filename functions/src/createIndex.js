...
<script>
  ...
  <link rel="preload" href="/__/firebase/7.11.0/firebase-app.js" as="script">

  <link rel="preload" href="/__/firebase/7.11.0/firebase-auth.js" as="script">

  <link rel="preload" href="/__/firebase/7.11.0/firebase-firestore.js" as="script">

  <link rel="preload" href="/__/firebase/7.11.0/firebase-storage.js" as="script">
...
<script type="module">
  const loadApp = () => {
    ...
    document.getElementById('app').src="/src/hg-app.js";
  };
  ...
  firebaseInitScript.addEventListener("error", async () => {
    ...
    firebase.initializeApp({"apiKey":"AIzaSyDvamIugzBC3k3WA52KpHeINrfDHfkvnSs","authDomain":"pl-hotelgarden.firebaseapp.com","databaseURL":"https://pl-hotelgarden.firebaseio.com","projectId":"pl-hotelgarden","storageBucket":"pl-hotelgarden.appspot.com","messagingSenderId":"439170507609","appId":"1:439170507609:web:d50495f3bf9c9613702248","measurementId":"G-T7DQCNYLP2"});
    loadApp();
  });
</script>
